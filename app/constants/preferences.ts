...
const Preferences = {
    ...
    THEMES: {
        ...
        sandstone: {
            ...
            sidebarBg: '#c8a17a',             
            sidebarText: '#3f2f24',
            sidebarUnreadText: '#3f2f24',
            sidebarTextHoverBg: '#d2b49a',
            sidebarTextActiveBorder: '#a67c52',
            sidebarTextActiveColor: '#3f2f24',
            sidebarHeaderBg: '#b99a7e',
            sidebarHeaderTextColor: '#ffffff',
            sidebarTeamBarBg: '#a07e5d',
            onlineIndicator: '#3db887',
            awayIndicator: '#ffbc1f',
            dndIndicator: '#d24b4e',
            mentionBg: '#ffffff',
            mentionColor: '#c8a17a',
            centerChannelBg: '#faf0e6',
            centerChannelColor: '#3f2f24',
            newMessageSeparator: '#cc8f00',
            linkColor: '#386fe5',
            buttonBg: '#a67c52',
            buttonColor: '#ffffff',
        ...
        light_gray: {
            ...
            sidebarTextActiveBorder: '#999999',
            sidebarTextActiveColor: '#1f2228',
            sidebarHeaderBg: '#e8e8e8',
            sidebarHeaderTextColor: '#1f2228',
            sidebarTeamBarBg: '#dcdcdc',
            onlineIndicator: '#3db887',
            awayIndicator: '#ffbc1f',
            dndIndicator: '#d24b4e',
            mentionBg: '#c8c8c8',
            mentionColor: '#1f2228',
            centerChannelBg: '#ffffff',
            centerChannelColor: '#1f2228',
            newMessageSeparator: '#cccccc',
            linkColor: '#386fe5',
            buttonBg: '#999999',
            buttonColor: '#ffffff',
            errorTextColor: '#d24b4e',
            mentionHighlightBg: '#e0e0e0',
            mentionHighlightLink: '#1b1d22',
            codeTheme: 'github',
        },
